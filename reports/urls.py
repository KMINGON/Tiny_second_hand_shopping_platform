...
urlpatterns = [
    ...
    path('products/report/<int:product_id>/', views.report_product_view, name='report_product'),
    path('product/<int:product_id>/', views.report_product_view, name='report_product'),
]